...
- [Як відбувається підключення агентів](ai_coding_agents_setup.md) - детальний посібник з налаштування різних ШІ-агентів кодування
- [Як формулювати ефективні запити](formulating_prompts_for_ai_coding_agents.md) - найкращі практики для ефективної взаємодії з агентами
- [Як формулювати завдання для агентів](task_formulation.md) - посібник з постановки завдань для різних ШІ-агентів
