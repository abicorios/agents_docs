...
Цей документ є частиною серії про ШІ-агенти кодування:

- [Налаштування ШІ-агентів кодування](ai_coding_agents_setup.md) - детальна інформація про процес встановлення та налаштування різних ШІ-агентів
